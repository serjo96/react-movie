            ...
            <div className='mobile-filter'>
              ...
              {this.props.genres.length > 0
                ? <div className='mobile-filter__select'>
                  ...
                  <label className='mobile-filter__label'>
                    <select
                      name='' id='' onChange={(e) => this.props.onClickGenres({
                        name: e.target.value,
              ...
              <div className='mobile-filter__select'>
                ...
                <label className='mobile-filter__label' htmlFor=''>
                  <select
                    name='' id='' onChange={e => this.props.onSortByDate({
                      name: e.target.value,
              ...
              {this.props.sortByCountry ? <div className='mobile-filter__select'>
                ...
                <label className='mobile-filter__label' htmlFor=''>
                  <select
                    name='' id='' onChange={e => this.props.onSortByCountry({
                      name: e.target.value,
              ...
              <div className='mobile-filter__select'>
                ...
                <label className='mobile-filter__label' htmlFor=''>
                  <select
                    name='sortBy' id='' onChange={e => this.props.onClickSort({
                      name: e.target.value,
                      type: e.target.options[e.target.selectedIndex].dataset.type
                    })}
                  >
              ...
              <div
                onClick={this.props.onClickChangeDir} className={`mobile__sort-direction sort-direction ${sortSettings.sortDirection
                                ? 'sort-direction--asc'
                                : ''}`}
              >
