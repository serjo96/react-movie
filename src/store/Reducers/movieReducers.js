...
export default function Movies (state = initialState, action) {
  switch (action.type) {
    ...
    case ALL_MOVIES:
      ...
      let totalPages = action.movies.data.total_results;
    ...
    case TOP_MOVIES:
      const results = action.movies.data.results.sort((a, b) => b.vote_average - a.vote_average);
      return update(state, {
        TopMovies: {
          $merge: {
            isFetching: true,
      ...
      return update(state, {
        MovieData: {
          $merge: {
            ...
            images: action.data.data.images.backdrops,
            posters: action.data.data.images.posters,
            crew: {
