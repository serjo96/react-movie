                 ...
                 <div className="movies-content">
			         ...
			         {OnTheAirTv.data.total_pages > 1 ?
                         <div className="pager-btns clearfix">
					         {OnTheAirTv.data.page-1 > 1 ? <div className="pager-btn pager-btn--prev link-angle" onClick={this.prevPage}><i className="fa fa-angle-left" aria-hidden="true" /><span>Предыдущая страница</span></div> :null}
